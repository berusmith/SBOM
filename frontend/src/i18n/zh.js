const zh = {
  ...
  nav: {
    ...
    account:      "帳號",
    logout:       "登出",
    openSourceNotices: "開源授權聲明",
    openMenu:     "開啟選單",
    closeMenu:    "關閉選單",
    lockedHint:   "需要 {{plan}} 方案",
  },
  ...
  login: {
    ...
    error:      "帳號或密碼錯誤",
    orDivider:  "或",
    ssoButton:  "使用公司帳號登入（SSO）",
    forgotPassword: "忘記密碼？",
    ssoFailed:  "SSO 登入失敗，請重試",
  },

  // ── 確認對話框 ────────────────────────────────────────────────────────────
  confirm: {
    typeToConfirm: "請輸入 {{name}} 以確認此操作",
  },
  ...
  dashboard: {
    ...
    gradedOf:             "{{graded}} / {{total}} 版本已評分",
    riskyComponents:      "高風險元件",
    riskySubtitle:        "跨版本 Critical/High 未處理漏洞最多",
    riskyCol:             "元件",
    riskyColVersions:     "版本數",
    riskyColUnpatched:    "未處理 C/H",
    ...
    riskOverviewCol: {
      ...
      products:          "產品",
      totalVulns:        "總漏洞",
      unpatchedCritical: "未修 Critical",
      unpatchedHigh:     "未修 High",
      patchRate:         "修補率",
      riskScore:         "風險評分",
    },
    cveImpact:            "CVE 影響查詢",
